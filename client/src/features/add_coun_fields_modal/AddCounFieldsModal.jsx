...
import { addFieldsToCounsellor } from "../../service/dephead_service/depCounsellorService";



const AddCounFieldsModal = ({ handleClose, initFieldList, toggle, dataOnChange, counsellorId }) => {
...
export default AddCounFieldsModal